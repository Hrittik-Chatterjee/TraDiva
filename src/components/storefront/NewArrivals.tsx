...
const newArrivalsList: ProductMock[] = [
  {
    title: "Handwoven Phanek",
    image: "https://images.unsplash.com/photo-1583391265517-35bbdad01209?q=80&w=600&auto=format&fit=crop",
    category: "phanek"
  },
  {
    title: "Traditional Silk Dupatta",
    image: "https://images.unsplash.com/photo-1590156546746-c233f283b6ec?q=80&w=600&auto=format&fit=crop",
    category: "urna"
  },
  {
    title: "Premium Muga Saree",
    image: "https://images.unsplash.com/photo-1610030469618-9f14cb9c39e0?q=80&w=600&auto=format&fit=crop",
    category: "saree"
  },
  {
    title: "Floral Zari Innaphi",
    image: "https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?q=80&w=600&auto=format&fit=crop",
    category: "innaphi"
  },
  {
    title: "Traditional Kesa Shawl",
    image: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=600&auto=format&fit=crop",
    category: "innaphi"
  },
  {
    title: "Heritage Silk Urna",
  ...
  return (
    <section className="w-full py-16 md:py-24 px-6 bg-lightest-pink">
      <div className="page-container">
        {/* Top Header matching BlueprintSection / FeaturedProducts */}
